...
$(document).ready(function(){
	/**
	 * Показываем кнопку только тогда, когда расширение установлено в режиме разработчика 
	*/
	if(Options.InstallType == "development"){
		$("#dev_button").show();
		/**
		 * Клик по кнопке перезагрузит расширение.
		 * Эх, гребаная лень тянутся на вкладку расширения и перезагружать оттуда ))
		*/
